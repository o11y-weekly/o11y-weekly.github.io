...
This is a great feature, all possible runtime errors have been forwarded to a compiler upfront. It is hard to have a unmanaged parsing failure. The returned value is a result and errors should be treated and verified.
...
:warning: This program will fail on error meaning that vector will stop on error.
